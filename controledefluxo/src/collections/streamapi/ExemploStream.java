...
public class ExemploStream {
    ...
    public static void main(String[] args) {
        ...
        // Retorna true se nenhum elemento possue a letra minúscula no nome
        System.out.println("Nao tem nenhum elemento com a minúscula no nome? " + estudantes.stream().noneMatch((elemento) -> elemento.contains("a")));
